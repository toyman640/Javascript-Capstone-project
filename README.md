<a name="readme-top"></a>
  ...
  <h3><b>Javascript-Capstone-project
</b></h3>
...
- The app allows users to view list of meals.
- Accepts data.
- Allows users to like and make comments.
- saves likes and comments
...
- With a git cmd, git bash or visual studio terminal, clone repo with **``git@github.com:toyman640/Javascript-Capstone-project.git``** to download the repository locally on your machine.
- Then you navigate to the folder in your code editor with the command *``cd Javascript-Capstone-project``*.
